...
/**
 * Use rand create to get a random flag from O_RDONLY, O_WRONLY and O_RDWR
 */
fn rand_falgs() -> c_int {
...
/**
 * Use system call open, read, write and close. open a file, read the text from it and write it to the screen, 
 * then close the file
 */
pub fn read_write() {
